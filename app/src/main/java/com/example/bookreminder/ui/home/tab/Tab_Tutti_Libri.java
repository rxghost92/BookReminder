...
public class Tab_Tutti_Libri extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_totali, container, false);
    ...
    public void onStart() {
        ...
        Query searchQuery = mRef3.child(uid).orderByChild("title");
