...
public class Tab_In_Corso extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_in_corso, container, false);
    ...
    public void onStart() {
        ...
        Query searchQuery = mRef3.child(uid).orderByChild("status").equalTo("reading");
