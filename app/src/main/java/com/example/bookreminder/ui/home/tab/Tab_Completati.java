...
public class Tab_Completati extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_completati, container, false);
    ...
    public void onStart() {
        ...
        Query searchQuery = mRef3.child(uid).orderByChild("status").equalTo("done");
